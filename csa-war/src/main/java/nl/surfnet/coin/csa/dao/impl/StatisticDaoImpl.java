...
import nl.surfnet.coin.csa.domain.StatResult;
...
public class StatisticDaoImpl implements StatisticDao {
  ...
  @Autowired
  private JdbcTemplate csaJdbcTemplate;
  ...
  public List<CompoundServiceProviderRepresenter> getCompoundServiceProviderSpLinks() {
    return csaJdbcTemplate.query("select id as id, service_provider_entity_id as sp_id from compound_service_provider", new RowMapper<CompoundServiceProviderRepresenter>(){
      @Override
  ...
  public void setcsaJdbcTemplate(JdbcTemplate csaJdbcTemplate) {
    this.csaJdbcTemplate = csaJdbcTemplate;
  }
