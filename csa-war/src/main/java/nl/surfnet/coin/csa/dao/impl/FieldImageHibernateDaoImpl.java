 ...
 */
@Repository
public class FieldImageHibernateDaoImpl extends GenericServiceHibernateImpl<FieldImage> implements FieldImageDao {

  public FieldImageHibernateDaoImpl() {
    super(FieldImage.class);
  }
