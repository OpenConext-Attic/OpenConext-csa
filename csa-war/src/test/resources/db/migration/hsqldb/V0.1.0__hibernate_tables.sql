...
START WITH 1 ),                         hide_in_protected_csa BIT, hide_in_public_csa BIT, lmng_id VARCHAR(255), service_provider_entity_id VARCHAR(255), PRIMARY KEY (id), UNIQUE (service_provider_entity_id));
